...
public class CardRabbit extends NeCard{
	...
	private static String code = NeCardCodes.Rabbit;
	private static String src = "assets\\EN\\Rabbit.png";

	public CardRabbit(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
