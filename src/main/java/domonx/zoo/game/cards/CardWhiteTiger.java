...
public class CardWhiteTiger extends NeCard{
	...
	private static String code = NeCardCodes.WhiteTiger;
	private static String src = "assets\\EN\\WhiteTiger.png";

	public CardWhiteTiger(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
