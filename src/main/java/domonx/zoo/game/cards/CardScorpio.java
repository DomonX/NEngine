...
public class CardScorpio extends NeCard{
	
	private static String code = NeCardCodes.Scorpio;
	private static String src = "assets\\EN\\Scorpio.png";

	public CardScorpio(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
