...
public class CardJaguar extends NeCard{
	...
	private static String code = NeCardCodes.Jaguar;
	private static String src = "assets\\EN\\Jaguar.png";

	public CardJaguar(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
