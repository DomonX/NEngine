...
public class CardChamaeleon extends NeCard{
	...
	private static String code = NeCardCodes.Chamaeleon;
	private static String src = "assets\\EN\\Chamaeleon.png";

	public CardChamaeleon(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
