...
public class CardWeasel extends NeCard{
	
	private static String code = NeCardCodes.Weasel;
	private static String src = "assets\\EN\\Weasel.png";

	public CardWeasel(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
