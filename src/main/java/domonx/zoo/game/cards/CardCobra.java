...
public class CardCobra extends NeCard{
	...
	private static String code = NeCardCodes.Cobra;
	private static String src = "assets\\EN\\Cobra.png";

	public CardCobra(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
