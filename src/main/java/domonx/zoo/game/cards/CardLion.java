...
public class CardLion extends NeCard{
	
	private static String code = NeCardCodes.Lion;
	private static String src = "assets\\EN\\Lion.png";

	public CardLion(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
