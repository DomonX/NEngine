...
public class CardWolf extends NeCard{
	
	private static String code = NeCardCodes.Wolf;
	private static String src = "assets\\EN\\Wolf.png";

	public CardWolf(String GUID, NeGraphicsModule graphics, INeActionListener listener, INeGameStateController state) {
